...
const Header = () => {
  ...
  return (
    <header>
      <nav>
        <ul>
        <li className='storeAddress'><a href={storeAddressURL} target="_blank" rel="noopener noreferrer">3314 Indianola Ave, Des Moines, IA, 50315</a></li>
          <li className="tooltip-container">
            <span className="tooltip-trigger">Hours</span>
            <div className="tooltip-content">{hoursTooltip}</div>
          </li>
          <li className='storeImg'><a href="#home"><img src={logoPath} alt="Logo" /></a></li>
          <li className='productsPage'><a href="#products">Products</a></li>
